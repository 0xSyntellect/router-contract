...
contract MainnetDeployerScript is Script {
    ...
    function run() public {
        ...
        router.setAdapter(0, thrusterAdapter);
...
// forge script script/mainnet-deployer.s.sol:MainnetDeployerScript --rpc-url $BLAST_RPC2 --private-key $PRIVATE_KEY --broadcast --gas-price 10000000
