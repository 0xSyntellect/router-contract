...
contract Ringv2Adapter is IAdapter {
            ...
            uint160(
                uint256(
                    keccak256(
                        abi.encodePacked(
                            hex"ff",
                            0x24F5Ac9A706De0cF795A8193F6AB3966B14ECfE6, //TODO: @audit update
                            keccak256(abi.encodePacked(token0, token1)),
                            hex"501ce753061ab6e75837b15f074633bb775f5972f8dc1112fcc829c2e88dc689" // init code hash //TODO: @audit update
                        )
                    )
                )
            )
