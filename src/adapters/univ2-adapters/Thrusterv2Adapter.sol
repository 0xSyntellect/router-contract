...
contract Thrusterv2Adapter is IAdapter {
            ...
            uint160(
                uint256(
                    keccak256(
                        abi.encodePacked(
                            hex"ff",
                            0x37836821a2c03c171fB1a595767f4a16e2b93Fc4, //TODO: @audit update
                            keccak256(abi.encodePacked(token0, token1)),
                            hex"32a9ff5a51b653cbafe88e38c4da86b859135750d3ca435f0ce732c8e3bb8335" // init code hash //TODO: @audit update
                        )
                    )
                )
            )
